...
void InitSelectPage(){
	...
	songs[0].Create("Images/tutorial_bg.png", "Images/tutorial_cover.png", "Images/tutorial_info.png", "Sounds/NAKKA_cut.mp3", "Images/tutorial_cs.png", "Images/tutorial_result.png", "NoteMaps/NAKKA_AKMU.txt");
